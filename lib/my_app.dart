...
import 'package:test/presentation/keyboard/page/numeric_keyboar_expense_page.dart';
import 'package:test/presentation/keyboard/page/numeric_keyboard_income_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/keyboard_income': (context) => const NumericKeyboardIncomePage(),
        '/keyboard_expense': (context) => const NumericKeyboardExpensePage(),
